pro fhd_versions_rlb
  ...
  case version of
    ...
    'rlb_polarized_diffuse_with_amp_corrected_calibration_May2021': begin
      recalculate_all = 0
      cal_bp_transfer = 0  ; changed this for calibration transfer
      ...
      model_catalog_file_path = filepath('GLEAM_v2_plus_rlb2019.sav',root=rootdir('FHD'),subdir='catalog_data')
      subtract_sidelobe_catalog = filepath('GLEAM_v2_plus_rlb2019.sav',root=rootdir('FHD'),subdir='catalog_data')
      diffuse_model = '/home/ubuntu/diffuse_maps_rm_corrected_Mar2021/diffuse_rm_corrected_'+STRING(obs_id)+'.sav'
      pad_uv_image = 1
      return_sidelobe_catalog = 1
      ring_radius = 0
      debug_region_grow = 0
    ...
    'rlb_pol_test_old_crosspol_phase_calc_May2021': begin
      recalculate_all = 0
      write_healpix_fits = 1
      calibration_catalog_file_path = filepath('GLEAM_v2_plus_rlb2019.sav',root=rootdir('FHD'),subdir='catalog_data')
      subtract_sidelobe_catalog = filepath('GLEAM_v2_plus_rlb2019.sav',root=rootdir('FHD'),subdir='catalog_data')
    ...
    'rlb_pol_test_new_crosspol_phase_calc_May2021': begin
      recalculate_all = 0
      write_healpix_fits = 1
      calibration_catalog_file_path = filepath('GLEAM_v2_plus_rlb2019.sav',root=rootdir('FHD'),subdir='catalog_data')
      subtract_sidelobe_catalog = filepath('GLEAM_v2_plus_rlb2019.sav',root=rootdir('FHD'),subdir='catalog_data')
    ...
    'rlb_diffuse_baseline_cut_optimal_weighting_Jun2021': begin
      recalculate_all = 1
      uvfits_version = 5
      uvfits_subversion = 1
      return_cal_visibilities = 0  ; changed this for calibration transfer
      ...
      diffuse_model = 0
      model_visibilities = 1
      model_catalog_file_path = '/home/ubuntu/pol_leakage_corrected_catalogs_Jun2021/'+string(obs_id)+'_decon_catalog_pol_leakage_corrected.sav'
      cal_bp_transfer = 0  ; changed this for calibration transfer
      transfer_calibration = '/home/ubuntu/calibration_transferred/'+string(obs_id)+'_cal.sav'
      transfer_weights = '/home/ubuntu/calibration_transferred/'+string(obs_id)+'_flags.sav'
      rephase_weights = 0
      ...
      n_pol = 4
      dimension = 208 ; limit the UV plane to regions that contain data
      image_filter_fn = 'filter_uv_optimal' ;filter has been renamed to optimal
      time_cut = -4 ;flag an extra 4 seconds from the end of each obs
      nside = 512 ;increase default Healpix nside
    end
    
    'rlb_transfer_cal_4pol_test1_Jun2021': begin
      recalculate_all = 1
      uvfits_version = 5
      uvfits_subversion = 1
      return_cal_visibilities = 0  ; changed this for calibration transfer
    ...
    'rlb_transfer_cal_4pol_test2_Jun2021': begin
      recalculate_all = 1
      uvfits_version = 5
      uvfits_subversion = 1
      return_cal_visibilities = 0  ; changed this for calibration transfer
    ...
    'rlb_subtract_diffuse_and_GLEAM_Jul2021': begin
      recalculate_all = 0
      return_cal_visibilities = 0  ; changed this for calibration transfer
      catalog_file_path = 0
      diffuse_calibrate = 0
    ...
    'rlb_subtract_diffuse_only_Jul2021': begin
      recalculate_all = 0
      return_cal_visibilities = 0  ; changed this for calibration transfer
      catalog_file_path = 0
      diffuse_calibrate = 0
    ...
    'rlb_subtract_StokesI_diffuse_and_GLEAM_Jul2021': begin
      recalculate_all = 0
      return_cal_visibilities = 0  ; changed this for calibration transfer
      catalog_file_path = 0
      diffuse_calibrate = 0

pro fhd_versions_rlb
  ...
  case version of
    ...
    'rlb_diffuse_survey_pol_leakage_correction_4pol_Jan2019': begin
      ...
      cal_bp_transfer = 0  ; changed this for calibration transfer
      transfer_calibration = '/home/ubuntu/calibration_transferred/'+string(obs_id)+'_cal_transferred.sav'
      transfer_weights = '/home/ubuntu/calibration_transferred/'+string(obs_id)+'_flags_transferred.sav'
      rephase_weights = 0
      restrict_hpx_inds = 0
      hpx_radius = 15
      subtract_sidelobe_catalog = filepath('GLEAM_v2_plus_rlb2019',root=rootdir('FHD'),subdir='catalog_data')

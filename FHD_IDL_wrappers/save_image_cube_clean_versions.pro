pro save_image_cube_clean_versions, obs_id, output_directory, version, platform
  ...
  case version of
    ...
    "save_image_cube_clean_cal1": begin
        beam_nfreq_avg=1
        ...
        vis_path = '/uvfits/'
            ...
            if stregex(hostname, 'salix', /boolean) eq 1 then begin
              vis_path = '/Volumes/Data2/elillesk/clean/clean_uvfits/flagged/'
            endif else begin
    ...
    "save_image_cube_clean_cal_fix1": begin
    ...
    'save_image_cube_clean_grid_unflagged1': begin
      beam_nfreq_avg = 1
      ...
      if platform eq 'aws' then begin
        ...
        if stregex(hostname, 'salix', /boolean) eq 1 then begin
          fhd_cal_folder = '/Volumes/Data2/elillesk/clean/fhd_save_image_cube_clean_cal_fix1/'
        endif else begin
      ...
      if platform eq 'aws' then begin
        ...
        if stregex(hostname, 'salix', /boolean) eq 1 then begin
          vis_path = '/Volumes/Data2/elillesk/clean/clean_uvfits/unflagged/'
        endif else begin
          vis_path = '';;'/data3/users/bryna/van_vleck_corrected/'
        endelse
      endelse
    ...
    'save_image_cube_clean_grid_flagged1': begin
      beam_nfreq_avg = 1
      restrict_hpx_inds = 'EoR0_high_healpix_inds_3x.idlsave'
  ...
  endelse
    ...
    ;;Should be the same as above except with different choice for vis_path
    'save_image_cube_clean_grid_flipflagged1': begin
      beam_nfreq_avg = 1
      restrict_hpx_inds = 'EoR0_high_healpix_inds_3x.idlsave'
    ...
    if stregex(hostname, 'salix', /boolean) eq 1 then begin
      vis_path = '/Volumes/Data2/elillesk/clean/clean_uvfits/flipflagged/'
    endif else begin
      vis_path = '';;'/data3/users/bryna/van_vleck_corrected/'
    endelse
  endelse

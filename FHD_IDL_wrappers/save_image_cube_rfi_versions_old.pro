pro save_image_cube_rfi_versions, obs_id, output_directory, version, platform
  ...
  case version of
    ...
    'save_image_cube_rfi_grid_unflagged2': begin
      beam_nfreq_avg = 1
      ...
      if platform eq 'aws' then begin
        ...
        if stregex(hostname, 'salix', /boolean) eq 1 then begin
          fhd_cal_folder = '/Volumes/Data2/elillesk/interference/fhd_save_image_cube_rfi_cal1/'
        endif else begin
  ...
  endelse
    ...
    ;;Should be the same as above except with different choice for vis_path
    'save_image_cube_rfi_grid_flipflagged1': begin
      beam_nfreq_avg = 1
      restrict_hpx_inds = 'EoR0_high_healpix_inds_3x.idlsave'
